...
public class Main {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("Harry Potter and the Philosopher's Stone", author1, 29.99, 1997);
        Book book2 = new Book("Harry Potter and the Chamber of Secrets", author1, 24.99, 1998);
        Book book3 = new Book("Harry Potter and the Prisoner of Azkaban", author1, 19.99, 1999);
        Book book4 = new Book("A Game of Thrones", author2, 39.99, 1996);
        Book book5 = new Book("A Clash of Kings", author2, 34.99, 1998);
        Book book6 = new Book("A Storm of Swords", author2, 49.99, 2000);
        Book book7 = new Book("The Hobbit", author3, 14.99, 1937);
        Book book8 = new Book("The Fellowship of the Ring", author3, 29.99, 1954);
        Book book9 = new Book("The Two Towers", author3, 24.99, 1954);
        Book book10 = new Book("The Return of the King", author3, 29.99, 1955);
